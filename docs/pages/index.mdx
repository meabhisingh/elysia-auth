...
**elysia-auth** is a powerful authentication middleware for [Elysia.js](https://elysiajs.com) applications, built on top of [`@auth/core`](https://authjs.dev). It provides seamless integration with various authentication providers and robust middleware solutions for protecting your routes.
